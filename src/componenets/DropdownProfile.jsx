...
function DropdownProfile({ align }) {
  ...
  useEffect(() => {
    ...
    if (userEmail) {
      axios.post(`http://localhost:3000/users/FindByEmail`, { email: userEmail })
        .then(response => {
      ...
      >
        ...
        >
          <div className="pt-0.5 pb-2 px-3 mb-1 border-b border-slate-200 dark:border-slate-700">
            <div className="font-medium text-slate-800 dark:text-slate-100">{`${userData.lastName} ${userData.firstName}`}</div>
